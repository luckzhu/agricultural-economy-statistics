    ...
    <el-row :gutter="10">
      <el-col :span="12" class="grid-wrapper">
        <border-box1 class="grid-content">
          <presence :chartData="cityData['汕头市']" id="guangzhou" />
        </border-box1>
        <border-box1 class="grid-content">
          <presence :chartData="cityData['韶关市']" id="shenzhen" />
        </border-box1>
      </el-col>
      <el-col :span="12" class="grid-wrapper">
        <border-box1 class="grid-content">
          <presence :chartData="cityData['河源市']" id="foshan" />
        </border-box1>
        <border-box1 class="grid-content">
          <presence :chartData="cityData['梅州市']" id="zhuhai" />
        </border-box1>
      </el-col>
    </el-row>
  </div>
