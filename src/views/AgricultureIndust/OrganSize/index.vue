    ...
    <el-row :gutter="10">
      <el-col :span="12" class="grid-wrapper">
        <border-box1 class="grid-content">
          ...
          <bar-horizontal id="fixAssets" height="25.6rem"  :chartData="fixAssets.sort" />
        </border-box1>
        <border-box1 class="grid-content">
          <chart-info :chartInfo="organSales.info" />
          <bar-horizontal id="organSales" height="25.6rem" :chartData="organSales.sort" title="农业产业化合作组织销售收入" />
        </border-box1>
      </el-col>
      <el-col :span="12" class="grid-wrapper">
        <border-box1 class="grid-content">
          <div class="grid-content">
            ...
            <bar-horizontal id="leadingSales" height="25.6rem" :chartData="leadingSales.sort" title="农业产业化龙头企业销售收入" />
          </div>
        </border-box1>
        <border-box1 class="grid-content">
          <chart-info :chartInfo="marketTurnover.info"  />
          <bar-horizontal id="marketTurnover" height="25.6rem" :chartData="marketTurnover.sort" title="农业产业化专业市场交易额" />
        </border-box1>
      </el-col>
    </el-row>
  </div>
